...
class InvoiceHelper
{
    ...
    {
        return [
            'invoice.*' => trans('plugins/hotel::invoice.invoice_information'),
            'account.*' => trans('plugins/hotel::invoice.bill_payment_user_account_information'),
            'payment_method' => trans('plugins/hotel::invoice.payment_method'),
            'payment_status' => trans('plugins/hotel::invoice.payment_status'),
            'payment_description' => trans('plugins/hotel::invoice.payment_description'),
            'settings.using_custom_font_for_invoice' => trans('plugins/hotel::invoice.check_using_custom_font'),
            'settings.font_family' => trans('plugins/hotel::invoice.font_family'),
            'settings.enable_invoice_stamp' => trans('plugins/hotel::invoice.check_enabled_invoice_stamp'),
            'settings.company_name_for_invoicing' => trans('plugins/hotel::invoice.company_name'),
            'settings.company_address_for_invoicing' => trans('plugins/hotel::invoice.company_address'),
            'settings.company_email_for_invoicing' => trans('plugins/hotel::invoice.company_email'),
            'settings.company_phone_for_invoicing' => trans('plugins/hotel::invoice.company_phone_number'),
        ];
    }
