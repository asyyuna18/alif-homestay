...
class PublicController extends BaseController
{
    ...
    public function getOverview()
    {
        ...
        SeoHelper::setTitle(trans('plugins/hotel::customer.account_information'));

        Theme::breadcrumb()
            ->add(trans('plugins/hotel::customer.account_information'), route('customer.overview'));
    ...
    {
        SeoHelper::setTitle(trans('plugins/hotel::customer.profile'));

        Theme::breadcrumb()
            ->add(trans('plugins/hotel::customer.profile'), route('customer.edit-account'));
    ...
    public function postEditAccount(EditAccountRequest $request, BaseHttpResponse $response)
    {
        ...
        return $response
            ...
            ->setMessage(trans('plugins/hotel::customer.update_profile_successfully'));
    }

    public function getChangePassword()
    {
        SeoHelper::setTitle(trans('plugins/hotel::customer.change_password'));

        Theme::breadcrumb()
            ->add(trans('plugins/hotel::customer.change_password'), route('customer.change-password'));
    ...
    public function postChangePassword(UpdatePasswordRequest $request, BaseHttpResponse $response)
    {
        ...
        return $response->setMessage(trans('plugins/hotel::customer.update_password_successfully'));
    }
    ...
    public function postAvatar(AvatarRequest $request, ThumbnailService $thumbnailService, BaseHttpResponse $response)
    {
        try {
            ...
            return $response
                ->setMessage(trans('plugins/hotel::customer.update_avatar_success'))
