...
class BookingController extends BaseController
{
    ...
    {
        SeoHelper::setTitle(trans('plugins/hotel::booking.bookings'));
        ...
        Theme::breadcrumb()
            ->add(trans('plugins/hotel::booking.bookings'), route('customer.bookings'));
    ...
    public function show(int|string $id)
    {
        ...
        Theme::breadcrumb()
            ->add(
                trans('plugins/hotel::hotel.booking_information'),
