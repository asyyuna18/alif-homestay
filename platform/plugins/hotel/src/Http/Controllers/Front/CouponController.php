...
class CouponController extends BaseController
{
    ...
    public function apply(Request $request, CouponService $couponService): BaseHttpResponse
    {
        ...
        if ($coupon === null) {
            return $this->response
                ->setError()
                ->setMessage(trans('plugins/hotel::coupon.coupon_invalid'));
        }
        ...
        return $this->response
            ->setMessage(trans('plugins/hotel::coupon.applied_coupon_successfully', ['code' => $couponCode]));
    }
    ...
    public function remove(): BaseHttpResponse
    {
        ...
        if (! $couponCode) {
            return $this->response
                ->setError()
                ->setMessage(trans('plugins/hotel::coupon.coupon_not_used_yet'));
        }
        ...
        return $this->response
            ->setMessage(trans('plugins/hotel::coupon.removed_coupon_successfully', ['code' => $couponCode]));
    }
