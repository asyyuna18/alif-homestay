    ...
    public function setup(): void
    {
        ...
        $this
            ...
            ->add('hotel_enable_auto_detect_visitor_currency', 'onOffCheckbox', [
                ...
                'help_block' => [
                    'text' => trans('plugins/hotel::currency.auto_detect_visitor_currency_helper'),
                ],
            ])
            ->add('hotel_add_space_between_price_and_currency', 'onOffCheckbox', [
                ...
                'help_block' => [
                    'text' => trans('plugins/hotel::currency.add_space_between_price_and_currency_helper'),
                ],
            ])
            ->add('hotel_thousands_separator', 'customSelect', [
                ...
                'help_block' => [
                    'text' => trans('plugins/hotel::currency.thousands_separator_helper'),
                ],
            ])
            ->add('hotel_decimal_separator', 'customSelect', [
                'label' => trans('plugins/hotel::currency.decimal_separator'),
                'selected' => setting('hotel_decimal_separator', '.'),
                'choices' => [
                    ',' => trans('plugins/hotel::currency.separator_comma'),
                    '.' => trans('plugins/hotel::currency.separator_period'),
                    'space' => trans('plugins/hotel::currency.separator_space'),
                ...
                'help_block' => [
                    'text' => trans('plugins/hotel::currency.decimal_separator_helper'),
                ],
            ])
