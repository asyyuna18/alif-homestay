                ...
                <div class="table-responsive mb-20">
                    <table class="table table-striped custom-review-table">
                        <thead class="text-center">
                            <tr>
                                <th style="width: 15%">{{ trans('plugins/hotel::customer.room') }}</th>
                                <th style="width: 15%">{{ trans('plugins/hotel::customer.image') }}</th>
                                <th>{{ trans('plugins/hotel::customer.content') }}</th>
                            </tr>
                        </thead>
                        ...
                        @else
                            <tr>
                                <td colspan="5" class="text-center">{{ trans('plugins/hotel::customer.no_reviews') }}</td>
                            </tr>
                        @endif
                        </tbody>
                    </table>
