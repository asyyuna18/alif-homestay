                ...
                <div class="table-responsive mb-20">
                    <table class="table table-striped custom-booking-table">
                        <thead class="text-center">
                            <tr>
                                <th>{{ trans('plugins/hotel::customer.room') }}</th>
                                <th>{{ trans('plugins/hotel::customer.image') }}</th>
                                <th>{{ trans('plugins/hotel::customer.amount') }}</th>
                                <th>{{ trans('plugins/hotel::customer.booking_period') }}</th>
                                <th>{{ trans('plugins/hotel::customer.status') }}</th>
                                <th></th>
                            </tr>
                        </thead>
                                ...
                                @foreach ($bookings as $booking)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            ...
                                            >{{ trans('plugins/hotel::customer.view') }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            @else
                                <tr>
                                    <td
                                        class="text-center"
                                        colspan="5"
                                    >{{ trans('plugins/hotel::customer.no_bookings') }}</td>
                                </tr>
                            @endif
                        </tbody>
                    </table>
