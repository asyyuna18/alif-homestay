    ...
    <x-core::custom-template id="currency_template">
        ...
        <li data-id="__id__" class="clearfix currency-item">
            <div class="currency-row">
                <div class="swatch-item" data-type="title" data-label="{{ trans('plugins/hotel::currency.code') }}">
                    <input type="text" class="form-control" value="__title__">
                </div>
                <div class="swatch-item" data-type="symbol" data-label="{{ trans('plugins/hotel::currency.symbol') }}">
                    <input type="text" class="form-control" value="__symbol__">
                </div>
                <div class="swatch-item swatch-exchange-rate" data-type="exchange_rate" data-label="{{ trans('plugins/hotel::currency.exchange_rate') }}">
                    <input type="number" class="form-control input-exchange-rate" value="__exchangeRate__" step="0.00000001">
                </div>
                <div class="swatch-is-default" data-type="is_default" data-label="{{ trans('plugins/hotel::currency.is_default') }}">
                ...
                <div class="swatch-advanced">
                    <button type="button" class="btn btn-sm btn-secondary toggle-advanced" title="{{ trans('plugins/hotel::currency.advanced_settings') }}">
                        <x-core::icon name="ti ti-settings" />
                    </button>
                </div>
                <div class="remove-item" data-label="{{ trans('plugins/hotel::currency.remove') }}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label">{{ trans('plugins/hotel::currency.number_of_decimals') }}</label>
                                <input type="number" class="form-control" data-type="decimals" value="__decimals__">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label">{{ trans('plugins/hotel::currency.number_format_style') }}</label>
                                <select class="form-select" data-type="number_format_style">
                                    <option value="western" __westernFormatChecked__>{{ trans('plugins/hotel::currency.western_format') }}</option>
                                    <option value="indian" __indianFormatChecked__>{{ trans('plugins/hotel::currency.indian_format') }}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <label class="form-label">{{ trans('plugins/hotel::currency.is_prefix_symbol') }}</label>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">{{ trans('plugins/hotel::currency.space_between_price_and_currency') }}</label>
                                </div>
                            </div>
                        </div>
                    </div>
