...
if (! function_exists('riorelax_theme_url')) {
    function riorelax_theme_url(?string $url): string
    {
        $url = trim((string) $url);
...
app()->booted(function (): void {
    ...
    ProfileForm::extend(function (ProfileForm $form): void {
        ...
        $form
            ...
            ->addAfter('instagram', 'linkedin', TextField::class, TextFieldOption::make()->label(__('Linkedin'))->metadata()->placeholder('https://www.linkedin.com')->toArray());
    });
});
