...
class GallerySeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $galleries = [
            ...
            [
                'name' => 'Hotel',
                'description' => 'Experience opulence redefined at Alif Homestay. Our meticulously designed rooms and suites offer breathtaking views, plush amenities, and a haven of tranquility. Immerse yourself in sumptuous comfort that sets the stage for an unforgettable stay.',
            ],
            [
                'name' => 'Event Hall',
